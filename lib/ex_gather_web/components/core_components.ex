defmodule ExGatherWeb.CoreComponents do
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="mt-10 space-y-8 bg-gray900 text-white">
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-brand py-2 px-3",
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block w-full rounded-lg text-zinc-900 bg-gray900 text-white focus:ring-0 sm:text-sm sm:leading-6 min-h-[6rem]",
  ...
  def icon(%{name: "custom-video-camera-slash"} = assigns) do
    ~H"""
    <svg
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExGatherWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExGatherWeb.Gettext, "errors", msg, opts)
    end
  end
